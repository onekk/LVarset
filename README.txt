...
it analyzes all the objects in the drawing and creates a window where one can choose among all the objects of the drawing and select all the Properties one is interested in, and then import them into a varset, that will be created automatically. 
